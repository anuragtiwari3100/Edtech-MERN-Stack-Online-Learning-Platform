        ...
        <Link to="/signup" >
                <div className='group mt-16 p-1 mx-auto  rounded-full bg-richblack-800 font-bold
                 text-richblack-200 transition-all duration-200 hover:scale-95'>
                        <div className='flex flex-row items-center gap-2 -full px-10
                         py-[5px]  transition-all duration-200 rounded-full  group-hover:bg-richblack-900'>
                   ...
                   <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                     <div className='text-3xl lg:text-4xl font-semibold w-full lg:w-[45%]'>
                       Build the skills that
                        <HighlightText text={"top employers are looking for today"}/>
                     </div>
